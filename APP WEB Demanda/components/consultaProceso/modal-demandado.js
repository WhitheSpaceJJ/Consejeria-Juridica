...
const html = await (await fetch('../assets/modal-demandado.html')).text()
template.innerHTML = html

export class ModalDemandado extends HTMLElement {
...
customElements.define('modal-demandado', ModalDemandado)
