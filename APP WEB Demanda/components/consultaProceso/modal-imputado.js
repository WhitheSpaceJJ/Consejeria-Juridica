...
const html = await (await fetch('../assets/modal-imputado.html')).text()
template.innerHTML = html

export class ModalImputado extends HTMLElement {
...
customElements.define('modal-imputado', ModalImputado)
