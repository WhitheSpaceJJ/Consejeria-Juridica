...
const html = await (await fetch('../assets/modal-promovente.html')).text()
template.innerHTML = html

export class ModalPromovente extends HTMLElement {
...
customElements.define('modal-promovente', ModalPromovente)
