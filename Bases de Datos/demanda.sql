...
CREATE TABLE `demanda` (
  ...
  UNIQUE KEY `id_proceso_judicial` (`id_proceso_judicial`) USING BTREE,
...
INSERT INTO `juzgado` VALUES (1,'juzgado1','ACTIVO');
...
CREATE TABLE `participante` (
  ...
  CONSTRAINT `participante_ibfk_4` FOREIGN KEY (`id_proceso_judicial`) REFERENCES `proceso_judicial` (`id_proceso_judicial`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proceso_judicial` VALUES (1,'2024-03-12','2024-03-16','2024-06-22','area seguimiento','222',1,1);
...
-- Dump completed on 2024-03-15 19:22:24
