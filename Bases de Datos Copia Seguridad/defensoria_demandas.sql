...
INSERT INTO `domicilio_participante` VALUES (1,'Argentin aaaaaaa','279','',21225,1),(2,'Alberto Vargas aaaaaaaaaaaaaaa','2909','',107729,2),(3,'Alberto','2905','',4844,3),(4,'Alberto Vargas','2908','',107729,4),(5,'Kauri','8956','',93593,5),(6,'sadadsa','213112','',145488,6);
...
INSERT INTO `estado_procesal` VALUES (1,'Prueba atualizada','2024-04-07',1),(2,'Prueba 1asdsadads','2024-04-08',2);
...
INSERT INTO `etnia` VALUES (1,'Yaqui','ACTIVO'),(2,'Mayos','INACTIVO');
...
INSERT INTO `familiar` VALUES (1,'Julia Antonieta','Mexicana','Madre',1,1,1,0,1),(2,'Julia','Mexicana','Tia',1,1,1,1,3);
...
INSERT INTO `imputado` VALUES (2),(4),(6);
...
INSERT INTO `observacion` VALUES (1,'Prueba atualizada',1),(2,'Prueba 3sadasd',2),(12,'dd',1);
...
INSERT INTO `participante` VALUES (1,'Juan a','Pérez yyy','García   yyyyy',25,'644123456',2,1),(2,'Judith aaaaa','Orozco yyy','Hernandez  yyyy',45,'4354534545',1,1),(3,'Jose Ramon','Diaz','Flores',21,'2121212121',1,2),(4,'Carlos ','Sauceda','Cervantes',45,'3454354354',1,2),(5,'Javier','Regis','Blas',25,'6441852682',1,3),(6,'erwerr','edfsa','sasad',24,'6442138093',1,3);
...
INSERT INTO `proceso_judicial` VALUES (1,'2024-04-10',NULL,'444444444','tttttttttt',2,1,60,10,13,'EN_TRAMITE',1),(2,'2024-04-08',NULL,'mmmmmlllll','rrrrryyyyy',1,5,135,5,1,'EN_TRAMITE',2),(3,'2024-04-26',NULL,'8888','999',4,4,210,13,13,'EN_TRAMITE',1);
...
INSERT INTO `promovente` VALUES (1,1,1,1,1),(3,1,1,1,1),(5,1,1,1,1);
...
INSERT INTO `prueba` VALUES (1,'Prueba 1 atualizada',1),(2,'Prueba 2asdsadad',2),(12,'aaaaaaaaaa',1);
...
INSERT INTO `resolucion` VALUES (1,'Prueba atualizada','2024-04-07',1),(2,'Prueba 7asdasdasd','2024-04-08',2),(12,'adsasd','2024-04-10',1);
...
-- Dump completed on 2024-05-05 23:28:32
